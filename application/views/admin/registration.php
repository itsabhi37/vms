...
<main class="app-content">
    <div class="app-title">
        <div>
          <h1><i class="fa fa-user-plus"></i> Visitor Details</h1>
          <p>New Visitor Registration & Existing Visitor Details View Section...</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="<?=base_url('registration')?>"> visitor details</a></li>
        </ul>
      </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="tile">
                <h3 class="tile-title">Visitor Registration</h3>
                <div class="tile-body">
                    <?php 
                    if($this->uri->segment(3)){ 
                        echo form_open_multipart('registration/update_visitor','class="form-horizontal style-form"');
                    } 
                    else{
                         echo form_open_multipart('registration/add_visitor','class="form-horizontal style-form"');
                    }                    
                   ?>
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                ?>
                                    ...
                                    <!--<input  onkeypress="return IsNumeric(event,'error');" onpaste="return false;" ondrop="return false;" type="text">-->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <?php
                                    if($this->uri->segment(3)){ 
                                        echo '<input class="form-control" name="poi" type="file" disabled>';
                                    }else{
                                        echo '<input class="form-control" name="poi" type="file" required>';
                                    }
                                ?>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <?php
                                    if($this->uri->segment(3)){ 
                                        echo '<input class="form-control" name="visitorimage" type="file" disabled>';
                                    }else{
                                        echo '<input class="form-control" name="visitorimage" type="file" required>';
                                    }
                                ?>
                            </div>
                        </div>
                        <!--<div class="form-group row">
                            <div class="col-md-8 col-md-offset-3">
                                <div class="animated-checkbox">
                                    <label>
                                    <input type="checkbox" checked><span class="label-text">I accept the terms and conditions</span>
                                  </label>
                                </div>
                            </div>
                        </div>-->
                        <div class="tile-footer">
                            <div class="row">
                                <div class="col-md-8 col-md-offset-3">
                                    ...
                                    <a class="btn btn-secondary" href="<?=base_url('registration')?>"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                                </div>
                            </div>
                        </div>
                        <br/>
                                    ...
                                    <div class="btn-group">
                                        <?php
                                            ...
                                            echo '<a class="btn btn-primary btn-sm" disabled><i style="color:#fff;" class="fa fa-eye"></i></a>';
                                                ...
                                                ?>
                                            <a onclick="getVisitor('<?php echo $vst->uname;?>');" href="#" data-href="#" style="outline:none;" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModalView" title="View Profile"><i style="color:#fff;" class="fa fa-eye"></i></a>
                                            <?php
                                            }
                                        ?>
                                                <a class="btn btn-primary btn-sm" href="<?=base_url('registration/edit_visitor/'.$vst->uname)?>" title="Edit"><i style="color:#fff;" class="fa fa-edit"></i></a>
                                                <a data-href="<?=base_url('registration/delete_class/'.$vst->uname)?>" class="btn btn-primary btn-sm deletModel" title="Delete"><i style="color:#fff;" class="fa fa-trash-o"></i></a>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach;?>
...
<script type="text/javascript">
    ...
    function getVisitor(val) {
        $.ajax({
            type: "POST",
            url: "registration/show_profile/" + val,
            beforeSend: function() {
