...
<main class="app-content">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?=base_url('bookpc')?>">Book System</a></li>
        </ul>
    </div>
    <div class="row">
        <?php 
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="face back">
                                                    <div class="inner text-center">
                                                       ...
                                                       <a href="<?=base_url('bookpc/bookme/'.$ip)?>"class="btn btn-primary"><i class="fa fa-smile-o"></i>Book Me</a>                                                                                               
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
